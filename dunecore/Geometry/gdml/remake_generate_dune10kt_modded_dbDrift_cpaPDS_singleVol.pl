...
####################################################################
###############  Double Sided Arapuca Dimensions ###################
...
$ArapucaOut_y = 11.8;
$ArapucaOut_z = 209.2;
#$ArapucaOut_z = $APAFrame_z - 2*$APAFrameYSide_z;
$ArapucaIn_x = 2.4;
$ArapucaIn_y = 9.3;
$ArapucaIn_z = 46.8;
...
$gapCenter_arapuca_z = 16.0;
$gapBetween_arapuca_z = 2.0;

$list_pos[0]=-0.5*$gapCenter_arapuca_z-1.5*$ArapucaIn_z-$gapBetween_arapuca_z;
$list_pos[1]=$list_pos[0]+$ArapucaIn_z+$gapBetween_arapuca_z;
$list_pos[2]=0.5*$gapCenter_arapuca_z+0.5*$ArapucaIn_z;
$list_pos[3]=$list_pos[2]+$ArapucaIn_z+$gapBetween_arapuca_z;

$nLightPaddlesPerCPA    =    9;
$PaddleYInterval_CPA    =    (2*$APAphys_y+$APAGap_y-$ArapucaOut_y-2*$APAFrameZSide_y)/(2*$nLightPaddlesPerCPA-1);
$FrameToPaddleSpace_CPA     =    ($PaddleYInterval_CPA-$APAGap_y)/2;

$nLightPaddlesPerAPA    =    10;   # 10, or 20 for double coverage (for now)
$PaddleYInterval        =    (2*$APAphys_y+$APAGap_y-$ArapucaOut_y-2*$APAFrameZSide_y)/(2*$nLightPaddlesPerAPA-1);
$FrameToPaddleSpace     =    ($PaddleYInterval-$APAGap_y)/2;

$local_each_cpa_paddle_pos_y[0] = 0 - $APAphys_y/2 + $ArapucaOut_y/2 + $APAFrameZSide_y;
$local_each_cpa_paddle_pos_y[1]= $local_each_cpa_paddle_pos_y[0] + $PaddleYInterval_CPA;
$local_each_cpa_paddle_pos_y[2]= $local_each_cpa_paddle_pos_y[1] + $PaddleYInterval_CPA;
$local_each_cpa_paddle_pos_y[3]= $local_each_cpa_paddle_pos_y[2] + $PaddleYInterval_CPA;
$local_each_cpa_paddle_pos_y[4]= $local_each_cpa_paddle_pos_y[3] + $PaddleYInterval_CPA;
$local_each_cpa_paddle_pos_y[5]= $local_each_cpa_paddle_pos_y[4] + $PaddleYInterval_CPA;
$local_each_cpa_paddle_pos_y[6]= $local_each_cpa_paddle_pos_y[5] + $PaddleYInterval_CPA;
$local_each_cpa_paddle_pos_y[7]= $local_each_cpa_paddle_pos_y[6] + $PaddleYInterval_CPA;
$local_each_cpa_paddle_pos_y[8]= $local_each_cpa_paddle_pos_y[7] + $PaddleYInterval_CPA;
...
-->
   ...
   <position name="posArapucaSub0"    unit="cm" x="0" y="0" z="@{[$list_pos[0]]}"/>
   <position name="posArapucaSub1"    unit="cm" x="0" y="0" z="@{[$list_pos[1]]}"/>
   <position name="posArapucaSub2"    unit="cm" x="0" y="0" z="@{[$list_pos[2]]}"/>
   <position name="posArapucaSub3"    unit="cm" x="0" y="0" z="@{[$list_pos[3]]}"/>
   <position name="posCathodeSub0"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[0]]}" z="0"/>
   <position name="posCathodeSub1"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[1]]}" z="0"/>
   <position name="posCathodeSub2"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[2]]}" z="0"/>
   <position name="posCathodeSub3"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[3]]}" z="0"/>
   <position name="posCathodeSub4"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[4]]}" z="0"/>
   <position name="posCathodeSub5"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[5]]}" z="0"/>
   <position name="posCathodeSub6"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[6]]}" z="0"/>
   <position name="posCathodeSub7"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[7]]}" z="0"/>
   <position name="posCathodeSub8"    unit="cm" x="0" y="@{[$local_each_cpa_paddle_pos_y[8]]}" z="0"/>
</define>
</gdml>
EOF
    close (DEF);
...
$APAFrameYOuterSupport_x = ($APAFrame_x-$ArapucaOut_x)/2;
...
<solids>
    ...
    <box name="Cathode0" lunit="cm"
     ...
     <subtraction name="Cathode1">
      ...
      <positionref ref="posCathodeSub0"/>
      </subtraction>
     <subtraction name="Cathode2">
      <first ref="Cathode1"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub1"/>
      </subtraction>
     <subtraction name="Cathode3">
      <first ref="Cathode2"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub2"/>
      </subtraction>
     <subtraction name="Cathode4">
      <first ref="Cathode3"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub3"/>
      </subtraction>
     <subtraction name="Cathode5">
      <first ref="Cathode4"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub4"/>
      </subtraction>
     <subtraction name="Cathode6">
      <first ref="Cathode5"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub5"/>
      </subtraction>
     <subtraction name="Cathode7">
      <first ref="Cathode6"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub6"/>
      </subtraction>
     <subtraction name="Cathode8">
      <first ref="Cathode7"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub7"/>
      </subtraction>
     <subtraction name="Cathode">
      <first ref="Cathode8"/>
      <second ref="ArapucaOut"/>
      <positionref ref="posCathodeSub8"/>
      </subtraction>
    ...
    {        # $j=0 for bottom APAs
      ...
      if( $workspace == 0 )
      {
          ...
          for($i=0 ; $i<$nAPAWide ; $i++)
          {
            ...
            place_OpDets($APACenter_x, $APACenter_y, $APACenter_z, $apa_i, $j);
            $tpc_0 = 2*$apa_i+0;
            $tpc_1 = 2*$apa_i+1;
            $apa_i++;
...
EOF
        ...
        # Make the workspace have only one center APA with CPAs and the full drift on either side
            ...
            place_APA($APACenter_x, $APACenter_y, $APACenter_z, $apa_i, $j);
            place_OpDets($APACenter_x, $APACenter_y, $APACenter_z, $apa_i, $CPA_0_x, $j);
            ...
            $rot_0       = "rPlus180AboutY";
            $rot_1       = "rIdentity";
            $rot_2       = "rPlus180AboutX";
            if($j == 0)           { $rot_0 = "rPlus180AboutXPlus180AboutY";
                              $rot_1 = "rPlus180AboutX"; 
                              $rot_2 = "rIdentity"} #put the readout end at the bottom for bottom APAs
...
sub place_OpDets()
{
    ...
    # }else{
	  ...
	  #   $posAra_x = ($APACenter_x-0.5*$ArapucaOut_x+0.5*$ArapucaAcceptanceWindow_x+0.1);
	  # }
    # come up with better solution in future (PD facing inward/+x) on the side of cathode
	  $rot_cpa = "rPlus180AboutY";
	  $posAra_x_cpa = ($CPACenter_x+0.5*$ArapucaOut_x-0.5*$ArapucaAcceptanceWindow_x+0.1);
...
EOF
}#end nwindow for-loop (for APA-side)
}#end Paddle for-loop (for APA-side)
for ($paddle = 0; $paddle<$nLightPaddlesPerCPA; $paddle++)
{
             # All Light Paddle centers will have the same
             #      X coordinate as the center of the current APA
             #      Z coordinate as the current TPC pair
            ...
            $Paddle_Y   =    $APACenter_y
                          - $APAphys_y/2
                          + $j*$FrameToPaddleSpace_CPA
                          + (1-$j)*($ArapucaOut_y/2 + $APAFrameZSide_y)
                          + $PaddleYInterval_CPA*$paddle;
...
$APAFrameYInnerSupport_x = $ArapucaOut_x;
